...
<body>
	<div class="navbar navbar-default navbar-fixed-top"  id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">Marpe Store</a>
			</div>
	...
	<!-- Slider Begins -->
	 ...
	 <div class="one-time">
	    <div><img src="assets/images/mint.jpg" style="width: 1500px; height: 400px;"></div>
	    <div><img src="assets/images/dandelion2.jpg" style="width: 1500px; height: 400px;"></div>
	    <div><img src="assets/images/sunflower.jpg" style="width: 1500px; height: 400px;"></div>
  	</div>
			...
			<div class="col-md-8">
				...
				<div class="panel panel-info">
					...
					<div id="get_product"></div>
						<!--<div class="col-md-4">
							<div class="panel panel-info">
								<div class="panel-heading">Peppermint</div>
								<div class="panel-body"><img src="assets/prod_images/mint.jpg"></div>
